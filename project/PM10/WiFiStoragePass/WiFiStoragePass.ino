...
#define CREDENTIALFILE "/fs/credfile" // Dont change this, esywifi lib uses this name !
#define DEBUG_X 1    // Debug mode for serial momitor, leave it and no Seriall is spammed
#define SEED 11      // Set your seed for the crypto hussler

char G_Ssid[32] = "MYWIRELESS";
char G_Pass[32] = "secretcode";
char G_code1[32]="Code1111",G_code2[32]="Code2222";
...
Serial.print(" SSid:[");Serial.print(G_Ssid);Serial.print("] decypher from [");Serial.print(G_code1);Serial.print("]\n" ); 
SimpleDecypher(G_code2,G_Pass);
Serial.print(" SSid:[");Serial.print(G_Pass);Serial.print("] decypher from [");Serial.print(G_code2);Serial.print("]\n" ); 
Serial.print("\n" ); 
...
Serial.print("Read Flash: SSid:[");Serial.print(G_code1);Serial.print("] Pass:[");Serial.print(G_code2);Serial.print("]\n" ); 
...
{
  int u,t,c=0;
  char buf[128],comma=30,zero=0; // seperators for end of record / end of string
  char bufc[128];
...
{
  int c=0;
  char comma=30, zero=0; // seperators for end of record / end of string
  char buf[32];
  WiFiStorageFile file = WiFiStorage.open(CREDENTIALFILE);
  if (file) {
